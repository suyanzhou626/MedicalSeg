...
from msdataloader_withpredict import MedicalSegWPredictDataModule
...
def cli_main():
    cli = LightningCLI(datamodule_class=MedicalSegWPredictDataModule, model_class=SegModel, seed_everything_default=False, run=False)
